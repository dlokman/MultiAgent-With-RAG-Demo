...
# prevents Strands from receiving a conversation history that ends with an incomplete/unresolved tool call e.g. a toolUse block
# with no toolResult. This is important because Strands will not be able to continue the conversation if it receives an
# incomplete toolUse block.
